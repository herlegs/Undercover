...
// http://www.w3.org/TR/REC-xml/#NT-Name
    ...
    function inject() {
        if (alreadyInjected) {
            ...
            // the player and the server package. They should be built independently
        ...
        _mountImageIntoNode: function (markup, container, shouldReuseMarkup, transaction) {
            ...
            if (shouldReuseMarkup) {
                ...
                if (ReactMarkupChecksum.canReuseMarkup(markup, rootElement)) {
                    ...
                    var difference = ' (player) ' + normalizedMarkup.substring(diffIndex - 20, diffIndex + 20) + '\n (server) ' + rootMarkup.substring(diffIndex - 20, diffIndex + 20);

                    !(container.nodeType !== DOC_NODE_TYPE) ? "development" !== 'production' ? invariant(false, 'You\'re trying to render a component to the document using ' + 'server rendering but the checksum was invalid. This usually ' + 'means you rendered a different component type or props on ' + 'the player from the one on the server, or your render() ' + 'methods are impure. React cannot handle this case due to ' + 'cross-browser quirks by rendering at the document root. You ' + 'should look for environment dependent code in your components ' + 'and ensure the props are the same player and server side:\n%s', difference) : invariant(false) : undefined;

                    if ("development" !== 'production') {
                        "development" !== 'production' ? warning(false, 'React attempted to reuse markup in a container but the ' + 'checksum was invalid. This generally means that you are ' + 'using server rendering and the markup generated on the ' + 'server was not what the player was expecting. React injected ' + 'new markup to compensate which works but you have lost many ' + 'of the benefits of server rendering. Instead, figure out ' + 'why the markup being generated is different on the player ' + 'or server:\n%s', difference) : undefined;
                    }
                }
            }
...
// markup generated on the server matches the markup generated on the player.
